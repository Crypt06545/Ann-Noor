      ...
      <div className="md:flex justify-between p-5 lg:p-16 gap-5">
        <div className="lg:w-[60%]">
          <div className="h-left-div">
            <h1 className="h-headibg lg:text-6xl font-robotoCondensed lg:leading-[1.1] text-3xl leading-[1.3] p-4  font-bold">
              Elevate Your Spirit with Victory Scented Fragrances!
            </h1>
            <p className="details font-robotoSlab lg:text-xl font-light p-4 text-gray-300">
          ...
          <div className="button-container p-4 flex flex-wrap gap-3 lg:gap-4">
            {/* oreder button  */}
        ...
        <div className="lg:w-[40%]">
          <div className="right-div flex justify-center items-center">
