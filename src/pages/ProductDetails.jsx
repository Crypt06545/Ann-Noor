          ...
          <div className="text-sm w-full md:w-1/2 text-zinc-200">
            ...
            <div className="mt-6">
              ...
              <p className="text-2xl font-medium text-amber-400">
                MRP: {product.offerPrice} <span>{currency}</span>
              </p>
            ...
            <div className="flex items-center mt-10 gap-4 text-base">
              <button
                onClick={addToCart}
                className="w-full py-3.5 cursor-pointer font-medium bg-zinc-800 text-amber-400 hover:bg-zinc-700 transition border border-zinc-700"
              >
                Add to Cart
              </button>
              <button onClick={buyNow} className="w-full py-3.5 cursor-pointer font-medium bg-amber-500 text-zinc-900 hover:bg-amber-600 transition">
                Buy now
              </button>
            </div>
          </div>
